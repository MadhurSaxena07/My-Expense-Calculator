...
class _NewTransactionState extends State<NewTransaction> {
  ...
  void _submit() {
    ...
    widget.atx(enteredTitle, enteredAmt, _selectedDate);
            ...
            child: Column(
              ...
              children: <Widget>[
                TextField(
                  ...
                  onSubmitted: (val) =>
                      _submit(), //onChanged: (val){titleinp=val;},
                ),
                TextField(
                  decoration: InputDecoration(labelText: 'Amount'),
                  controller: _amountcontroller,
                  keyboardType: TextInputType.numberWithOptions(),
                  onSubmitted: (_) => _submit(), //onChanged: (val)=>amtinp=val,
                ),
                Container(
                    height: 70,
                    child: Row(
                      children: <Widget>[
                        ...
                        Platform.isIOS? CupertinoButton( child: Text(
                            'Choose Date'), onPressed: __presentDatePicker) :  FlatButton(
                          child: Text(
                            'Choose Date',
                            style: TextStyle(
